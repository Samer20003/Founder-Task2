    ...
    <div className='row'>
        <div className='col-12 d-flex justify-content-center pt-5 mt-5'>
            <div className='login-wrapper w-25 p-3 rounded '>
                <h1 className='text-center'>Regstraion</h1>
                <form>
                <div className="mb-3">
                        <label for="exampleInputPassword1" className="form-label">User Name</label>
                        <input type="text" className="form-control rounded" id="exampleInputPassword1"/>
                    </div>
                    <div class="mb-3">
                    ...
                    <button type="submit" className="btn ps-5 pe-5 rounded">Sign up</button>
                    </form>
